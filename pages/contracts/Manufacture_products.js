...
class contractNew extends Component {
    ...
    render(){
        ...
        <Message color='olive'>
            <Message.Header>allowed access to this page is restricited only to the below provided user </Message.Header>
            <Message.List>0xc666E04444B69FC164D6c6DEe382A027E334675f : product manufacturer
            </Message.List>
        </Message>
